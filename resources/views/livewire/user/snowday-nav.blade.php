<div class="flex text-xs">
    @if ($prevSnowday->exists)
        <a href="{{ route_user_snowday($user, $prevSnowday) }}" class="flex flex-col space-y-0.5 px-3 items-end border-r border-black-300 border-dotted">
    ...
    @if ($nextSnowday->exists)
        <a href="{{ route_user_snowday($user, $nextSnowday) }}" class="flex flex-col space-y-0.5 px-3 items-start">
